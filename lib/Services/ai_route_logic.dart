String getSimulatedRoute(String destination, {String? from, String? mode}) {
  ...
  // CBD <-> Kasarani
  if ((origin == 'cbd' && dest == 'kasarani') ||
      (origin == 'kasarani' && dest == 'cbd')) {
    if (transport == 'matatu') {
  ...
  // CBD <-> Westlands
  if ((origin == 'cbd' && dest == 'westlands') ||
      (origin == 'westlands' && dest == 'cbd')) {
    if (transport == 'matatu') {
  ...
  // CBD <-> Thika Town
  if ((origin == 'cbd' && dest == 'thika town') ||
      (origin == 'thika town' && dest == 'cbd')) {
    if (transport == 'matatu') {
  ...
  // CBD <-> Rongai
  if ((origin == 'cbd' && dest == 'rongai') ||
      (origin == 'rongai' && dest == 'cbd')) {
    if (transport == 'matatu') {
  ...
  // CBD <-> Kikuyu Town
  if ((origin == 'cbd' && dest == 'kikuyu town') ||
      (origin == 'kikuyu town' && dest == 'cbd')) {
    if (transport == 'matatu') {
  ...
  // CBD <-> Eastlands
  if ((origin == 'cbd' && dest == 'eastlands') ||
      (origin == 'eastlands' && dest == 'cbd')) {
    if (transport == 'matatu') {
